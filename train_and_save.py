...
Trains the sentence embedding model on the full dataset and saves it to disk.
...
Output:
    app/model/logreg_classifier.joblib   — trained Logistic Regression
    app/model/label_classes.joblib       — class names array
"""
